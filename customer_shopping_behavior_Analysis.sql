...
round(100.0 * sum(case when discount_applied = 'Yes' then 1 else 0 end)/count(*),2) as dis_rate
from customer
group by item_purchased
...
select item_rank,category,item_purchased,total_order from item_type
where item_rank<=3

--Q9. Are customers who are repeat buyers (more than 5 previous purchases) also likely to subscribe?
select subscription_status, count(customer_id) as buyers
from customer
